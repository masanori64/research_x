...
VOYAGE_CONTEXT_4_LEARNING = PortfolioCandidate(
    ...
    preconditions=(
        "Group source-ref projection chunks by parent document before embedding.",
...
DEFAULT_RETRIEVAL_STRATEGIES: tuple[RetrievalStrategy, ...] = (
    RetrievalStrategy(
        ...
        purpose=(
            ...
            "and source-ref restoration as the baseline that challengers must beat."
        ),
        question_types=(
        ...
        promotion_gate=(
            "Any new embedding/provider arm must beat this baseline after source-ref "
    ...
    RetrievalStrategy(
        ...
        purpose=(
            ...
            "local candidates, but promotion is based on denoising, source-ref "
        ...
        candidates=(
            PortfolioCandidate(
                ...
                purpose=(
                    ...
                    "retrieval-text, and relation signals before answer-boundary context."
                ),
        ...
        promotion_gate=(
            ...
            "Hits remain candidates until restored to source restorations and "
        ...
        candidates=(
            PortfolioCandidate(
                ...
                preconditions=(
                    ...
                    "Restore original source restoration before context or citation generation.",
                ),
    ...
    RetrievalStrategy(
        ...
        purpose=(
            ...
            "rank/route contribution after source-ref restoration."
        ),
        question_types=(
            "multilingual_source",
            "learning_map",
        ...
        promotion_gate=(
            ...
            "Fusion must use rank/route contribution and then restore parent source restorations.",
    ...
    RetrievalStrategy(
        ...
        label="bounded rerank after source-ref restoration",
    ...
    RetrievalStrategy(
        ...
        promotion_gate=(
            "Promote a broad text recall arm only after portfolio-eval beats mode-aware "
            "baselines without route regression.",
            "Preserve source-ref restoration before answer generation.",
        ),
        rejection_gate=(
    ...
    RetrievalStrategy(
        ...
        promotion_gate=(
            ...
            "Must preserve quote/media/source-ref provenance.",
        ),
        rejection_gate=(
        ...
        candidates=(
            ...
            PortfolioCandidate(
                ...
                preconditions=(
                    ...
                    "Restore media hits to tweet/media source restorations before evidence use.",
    ...
    RetrievalStrategy(
        ...
        purpose=(
            ...
            "to media/tweet/bookmark/quote source restorations. Raw media matches are candidate "
        ...
        promotion_gate=(
            "Must restore 100% of media hits to source restorations.",
    ...
    RetrievalStrategy(
        ...
        rejection_gate=(
            (
                "Reject as primary path if source-ref provenance or local account ownership "
                "is lost."
            ),
        ),
