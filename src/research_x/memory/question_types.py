...
QUESTION_TYPES: tuple[QuestionType, ...] = (
    ...
    QuestionType(
        ...
        required_capabilities=("relation_expansion", "quote_context", "source_bundle", "citation"),
        current_readiness="medium",
        risk=(
    ...
    QuestionType(
        ...
        required_capabilities=("context_chunks", "citation_annotations", "source_bundle"),
        current_readiness="strong",
    ...
    QuestionType(
        ...
        required_capabilities=("media_context", "ocr_or_caption", "source_bundle", "citation"),
        current_readiness="weak",
