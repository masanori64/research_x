...
| S45 | `cognee` | https://github.com/topoteretes/cognee | Reference/provider-gated AI memory and Graph RAG platform candidate. Apache-2.0 license was reported from the upstream page during 2026-07-01 intake, but install, MCP/plugin setup, Docker, LLM_API_KEY usage, cloud use, and provider calls remain disabled. |
