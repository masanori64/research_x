    ...
    *,
    ...
    manifest = {
        ...
        "agent_advisory": {
            ...
            "provider_quota": "provider_execution_policy_required",
        },
    }
...
def _write_openai_agent_yaml(output: Path, agent_name: str) -> Path:
    ...
    default_prompt = (
        ...
        "bundle. Restore source restorations and verify context chunks/citations before answering."
    )
    lines = [
        "interface:",
...
def _write_hook_advisory(output: Path, agent_name: str) -> Path:
    ...
    text = "\n".join(
        [
            ...
            "- Final answers still need source-ref restoration, evidence views, and citations.",
        ]
    )
